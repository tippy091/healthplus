...
```
cd existing_repo
git remote add origin http://10.10.0.49/odoo/python-ekyc-service.git
git branch -M dev
...
- [ ] [Set up project integrations](http://10.10.0.49/odoo/python-ekyc-service/-/settings/integrations)
